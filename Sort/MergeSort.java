...
public class MergeSort {
    ...
    private static <Item extends Comparable> Queue<Queue<Item>>
        ...
        // Your code here!
        Queue<Queue<Item>> bigQ = new Queue<>();
        for (Item i : items) {
    ...
    public static <Item extends Comparable> Queue<Item> mergeSort(
        ...
        Queue<Queue<Item>> bigQ = makeSingleItemQueues(items);
        // Your code here!
        while (bigQ.size() > 1) {
            Queue<Item> q1 = bigQ.dequeue();
            Queue<Item> q2 = bigQ.dequeue();

            bigQ.enqueue(mergeSortedQueues(q1, q2));
        }
        return bigQ.dequeue();
    }
}
